...
print(performance_df.sort_values(by="Test-Acc", ascending=False))
best_models = [
  ("XGB", XGBClassifier(subsample=0.6, n_estimators=200, max_depth=7, learning_rate=0.1, colsample_bytree=1.0)),
  ("GBC", GradientBoostingClassifier(n_estimators=300, min_samples_split=2, min_samples_leaf=2, max_depth=5, learning_rate=0.2)),
  ("RFC", RandomForestClassifier(n_estimators=200, min_samples_split=5, min_samples_leaf=2, max_depth=None, criterion='gini')),
  ("KNN", KNeighborsClassifier(weights='uniform', p=1, n_neighbors=10, leaf_size=10, algorithm='brute')),
